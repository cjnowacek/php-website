<?php
// public/includes/contact_handler.php — ships to /includes/contact_handler.php on the server.
// The only server-side PHP outside /play/: receives the contact form POST.
